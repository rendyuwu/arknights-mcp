...
T2|.|M0 scaffold pyproject.toml + package src/arknights_mcp/ layout per PRD §20|-
T3|.|M0 pin deps → uv.lock (mcp>=1.28.1,<2, pydantic v2, sqlalchemy core, ruff, mypy, pytest)|V25
T4|.|M0 policy files DATA_SOURCES.md DATA_POLICY.md TAKEDOWN_POLICY.md PRIVACY.md NOTICE SECURITY.md + README unofficial disclaimer + LICENSE Apache-2.0|V16,V27
T5|.|M0 CLAUDE.md + AGENTS.md agent guardrails|-
...
T24|.|M1 versioned data/builds/*.sqlite + atomic current.json promote; retain N prev; unchanged→no-op|V3,V4
